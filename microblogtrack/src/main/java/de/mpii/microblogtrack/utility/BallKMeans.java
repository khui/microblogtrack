 ...
 *
 * A good reference for this class of algorithms is "The Effectiveness of
 * Lloyd-Type Methods for the k-Means Problem" by Rafail Ostrovsky, Yuval
 * Rabani, Leonard J. Schulman and Chaitanya Swamy. The code here uses the
 * seeding strategy as described in section 4.1.1 of that paper and the ball
 * k-means step as described in section 4.2. We support multiple iterations in
 * contrast to the algorithm described in the paper.
 */
public class BallKMeans implements Iterable<Centroid> {

    static Logger logger = Logger.getLogger(BallKMeans.class.getName());
    /**
     ...
     *
     * @param datapoints The datapoints to select from. These datapoints should
     * be WeightedVectors of some kind.
     */
